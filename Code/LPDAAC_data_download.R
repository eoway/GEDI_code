...
dl_dir <- "G:/My Drive/GEDI/Harvard_Forest/Data"             # Set dir to download files to
...
#files <- "https://e4ftl01.cr.usgs.gov/GEDI/GEDI01_B.001/2019.09.26/GEDI01_B_2019269031240_O04460_T02957_02_003_01.h5"
...
#files <- readLines("G:/My Drive/GEDI/Harvard_Forest/hf_gedi01_B_granules.csv", warn = FALSE)
#files <- readLines("G:/My Drive/GEDI/Harvard_Forest/hf_gedi02_A_granules.csv", warn = FALSE)
files <- readLines("G:/My Drive/GEDI/Harvard_Forest/hf_gedi02_B_granules.csv", warn = FALSE)
